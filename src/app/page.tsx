...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100">
      ...
      {/* Main Content */}
      <main className={`
        flex-1 p-3 sm:p-4 lg:p-6 overflow-auto min-h-screen
        lg:ml-64
        ${sidebarOpen ? 'lg:ml-64' : ''}
        pt-16 lg:pt-0
      `}>
        {/* Desktop Header */}
        <div className="hidden lg:flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-6 sm:mb-8">
          <div>
